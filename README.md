...
| &nbsp;&nbsp;**Build Azure** | [![Build Status](https://stef.visualstudio.com/AzurePipelinesTest/_apis/build/status/StefH.AzurePipelinesTest)](https://stef.visualstudio.com/AzurePipelinesTest/_build/latest?definitionId=5) |
